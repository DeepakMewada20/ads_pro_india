          ...
          {TIMELINE_STEPS.map((step, idx) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm hover:border-primary/40 hover:shadow-md transition-all duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
              >
